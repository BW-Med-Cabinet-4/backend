  ...
  return knex('ailments').truncate()
    .then(function () {
      ...
      return knex('ailments').insert([
        ...
        {ailment: 'stress', a_desc: 'high pressure job', user_id: '2'},
        {ailment: 'insomnia', a_desc: 'brain wont shut off', user_id: '3'},
        {ailment: 'anxiety', a_desc: 'social situations make me anxious', user_id: '4'},
        {ailment: 'depression', a_desc: 'bouts of depression hard to function', user_id: '5'},
